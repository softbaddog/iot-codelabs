/*!
    \file  spi_enc28j60.c
    \brief ENC28j60 spi ethnet driver 
*/

/*
    Copyright (C) 2016 LiteOS

    2017-07-07, V1.0.0, demo for STM32L452VE
*/
#include <string.h>
...
void enc28j60Init(unsigned char* macaddr)
{
    ...
    #if 1
    macx = enc28j60Read(MAADR5);
    macx = enc28j60Read(MAADR4);
    macx = enc28j60Read(MAADR3);
    macx = enc28j60Read(MAADR2);
    macx = enc28j60Read(MAADR1);
    macx = enc28j60Read(MAADR0);
    #else
    printf("MAADR5 = 0x%x\r\n", enc28j60Read(MAADR5));
    printf("MAADR4 = 0x%x\r\n", enc28j60Read(MAADR4));
    printf("MAADR3 = 0x%x\r\n", enc28j60Read(MAADR3));
